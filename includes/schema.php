...
$logo = "https://evakuator-kharkov.kh.ua/assets/images/2-1000x500.png";
...
if ($current_type == "articles") {
    $schema = [
        ...
        "publisher" => [
            ...
            "logo" => [
                "@type" => "ImageObject",
                "url" => "https://evakuator-kharkov.kh.ua/assets/images/icons8-taxi-service-64-64x64.png"
            ]
        ],
        // Даты лучше брать из базы, но пока ставим текущие или заглушки
